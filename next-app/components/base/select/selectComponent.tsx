        ...
        (open: boolean, display?: string) => (
            <>
                <div className="relative w-full">
                    <Listbox.Button className="relative w-full input input-bordered pr-10">
                    ...
                    <Transition show={open} as={Fragment} leave="transition ease-in duration-100" leaveFrom="opacity-100" leaveTo="opacity-0">
                        <Listbox.Options className="absolute z-10 mt-1 mb-0 mr-0 ml-0 max-h-56 w-full overflow-auto bg-base-100 rounded-lg border border-base-200 shadow-xl">
