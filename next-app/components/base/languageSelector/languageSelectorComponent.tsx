        ...
        <div className="dropdown dropdown-end">
            ...
            <ul tabIndex={0} className="mt-5 dropdown-content menu bg-base-100 border border-base-200 shadow-xl rounded-box w-52">
                <li className={`${i18n.language === 'en' && 'disabled'}`}>
                    {i18n.language !== 'en' ? (
                        <Link aria-label={t('languageButtonEnAriaLabel')} className="py-3 px-6 flex" href={router.asPath} locale={'en'}>
                            {t('en')}
                        </Link>
                    ) : (
                ...
                <li className={`${i18n.language === 'de' && 'disabled'}`}>
                    {i18n.language !== 'de' ? (
                        <Link aria-label={t('languageButtonDeAriaLabel')} className="py-3 px-6 flex" href={router.asPath} locale={'de'}>
                            {t('de')}
                        </Link>
                    ) : (
